...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(this, "đang gọi tới SubActivity1.onStart()", Toast.LENGTH_SHORT).show();
        Log.d(TAG, "======onStart======");
    }
    ...
    protected void onResume() {
        super.onResume();
        Toast.makeText(this, "đang gọi tới SubActivity2.onResume()", Toast.LENGTH_SHORT).show();
        Log.d(TAG, "======onResume======");
    }
